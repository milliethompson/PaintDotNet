...
namespace PaintDotNet
{
    ...
    public class EnumWrapper
    {
        ...
        {
            EnumWrapper wrapper = EnumWrapper.Create(enumType);
        ...
        public static EnumWrapper Create(Type enumType)
        {
            ...
            if (wrapper == null)
            {
                wrapper = new EnumWrapper(enumType);
                typeToWrapper[enumType] = wrapper;
            }

            return (EnumWrapper)wrapper;
        }

        private EnumWrapper(Type enumType)
        {
