...
{
	public class MosaicEffectConfigDialog : PaintDotNet.EffectConfigDialog
	{
		...
		public MosaicEffectConfigDialog()
		{
			...
			InitializeComponent();
			this.effectToken = new MosaicEffectConfigToken(2);

			// TODO: Add any initialization after the InitializeComponent call
			this.InitDialogFromToken();
		}
		...
		private void InitializeComponent()
		{
            ...
            this.cellSizeTrackBar.TabIndex = 0;
            ...
            this.cellSizeUpDown.TabIndex = 1;
            ...
            this.cellSizeUpDown.KeyUp += new System.Windows.Forms.KeyEventHandler(this.cellSizeUpDown_KeyUp);
		...
		protected override void InitDialogFromToken()
		{
		...
		{
			((MosaicEffectConfigToken)effectToken).CellSize = cellSizeTrackBar.Value;
			this.OnEffectTokenChanged();
		}
		...
		private void cellSizeUpDown_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
		{
