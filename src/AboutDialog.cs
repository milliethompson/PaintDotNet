...
namespace PaintDotNet
{
        ...
        : PdnBaseForm
    {
        ...
        public AboutDialog()
        {
			...
			this.linkLabel.Text = "Go to the Paint.NET website";
            ...
            this.Icon = SystemLayer.PdnGraphics.LoadApplicationIcon(); //new Icon(Utility.GetResourceStream("PaintDotNet.ico"));
        }
