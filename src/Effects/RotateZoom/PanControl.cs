...
namespace PaintDotNet.Effects.RotateZoom
{
        ...
        : UserControl
    {
        ...
        public PanControl()
        {
            if (!this.DesignMode)
            {
                handCursor = new Cursor(this.GetType().Assembly.GetManifestResourceStream(
                    "PaintDotNet.Effects.RotateZoom.Cursor.HandCursor.cur"));

                handMouseDownCursor = new Cursor(this.GetType().Assembly.GetManifestResourceStream(
                    "PaintDotNet.Effects.RotateZoom.Cursor.HandMouseDownCursor.cur"));
