...
// effect parameter token passed from EmbossEffectConfigDialog to 
// the EmbossEffect. builds the convolution filter weights according
// to specified angle
//
// Chris Crosetto
...
{
	/// <summary>
	/// Summary description for EmbossEffectConfigToken.
	/// </summary>
