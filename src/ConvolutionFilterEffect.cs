...
namespace PaintDotNet
{
        ...
        : Effect
	{
        ...
        public void RenderConvolutionFilter(int[,] weights, int offset, RenderArgs dstArgs, RenderArgs srcArgs, Region roi)
        {
        ...
        private class FExtentKey
        {
            ...
            {
                return unchecked(srcLength + (weightsLength << 16)); // assumes weightsLength is 65535 or less
            }
