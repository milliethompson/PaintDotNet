...
namespace PaintDotNet
{
    public class BitmapLayerPropertiesDialog : PaintDotNet.LayerPropertiesDialog
    {
        ...
        private System.Windows.Forms.Label backgroundExplainer;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                this.backgroundExplainer.Visible = true;
                this.Height += this.backgroundExplainer.Height;
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.backgroundExplainer = new System.Windows.Forms.Label();
            ...
            // backgroundExplainer
            // 
            this.backgroundExplainer.Location = new System.Drawing.Point(8, 168);
            this.backgroundExplainer.Name = "backgroundExplainer";
            this.backgroundExplainer.Size = new System.Drawing.Size(272, 16);
            this.backgroundExplainer.TabIndex = 8;
            this.backgroundExplainer.Text = "Note: Properties are locked for the Background layer.";
            this.backgroundExplainer.Visible = false;
            // 
            // BitmapLayerPropertiesDialog
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(290, 205);
            this.Controls.Add(this.backgroundExplainer);
            ...
            this.Controls.SetChildIndex(this.backgroundExplainer, 0);
