...
namespace PaintDotNet
{
	public class RecolorTool : Tool
	{
		...
		public RecolorTool(DocumentWorkspace parent)
			: base(parent)
		{
			toolBarImage = Utility.GetImageResource("Icons.RecoloringToolIcon.bmp");
			name = "Recolor";
			description = "Replaces the color under the brush with an alternate color";
			helpText = "Left click to replace the background color with the foreground color.";
