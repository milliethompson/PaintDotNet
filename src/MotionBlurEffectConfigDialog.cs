...
namespace PaintDotNet
{
	public class MotionBlurEffectConfigDialog 
        : PaintDotNet.EffectConfigDialog
	{
		...
		public MotionBlurEffectConfigDialog()
		{
            ...
            this.effectToken = new MotionBlurEffectConfigToken(25, 10, true);
            InitDialogFromToken();
        }

        private void InitTokenFromDialog()
        {
        ...
        {
            MotionBlurEffectConfigToken token = (MotionBlurEffectConfigToken)((MotionBlurEffectConfigToken)EffectToken).Clone();
		...
		private void InitializeComponent()
		{
            ...
            this.cancelButton.Location = new System.Drawing.Point(256, 100);
            ...
            this.okButton.Location = new System.Drawing.Point(176, 100);
